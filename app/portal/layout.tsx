...
import { LayoutDashboard, ShoppingBag, Phone, ImagePlus, BarChart2, Target, TrendingUp, Webhook, PackageSearch, Menu, X, Gift, ShieldCheck, LineChart, Mail, LayoutTemplate, Building2 } from 'lucide-react'
