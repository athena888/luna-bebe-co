    ...
    <>
      ...
      <main className="bg-cream-50 min-h-screen">
        <article className="max-w-2xl mx-auto px-6 sm:px-8 py-10 sm:py-14">
          <Link href="/journal" className="font-sans text-[11px] tracking-[0.14em] uppercase text-bark-400 hover:text-bark-600 transition-colors">← The Journal</Link>
          <p className="font-sans text-[11px] tracking-[0.16em] uppercase text-gold-400 mt-6 mb-3">
          ...
          <div className="mt-10 pt-6 border-t border-cream-300">
            <p className="font-sans text-[11px] tracking-[0.18em] uppercase text-gold-400 mb-4">Keep exploring</p>
