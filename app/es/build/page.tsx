...
export const metadata = {
  ...
  description: 'Elige cada pieza — canastillas para bebé y mamá, armadas a mano.',
  openGraph: esOpenGraph({ path: '/es/build', title: 'Arma tu canastilla | Petite Lavande', description: 'Elige cada pieza — canastillas para bebé y mamá, armadas a mano.' }),
  alternates: {
