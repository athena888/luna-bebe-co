...
export const metadata: Metadata = {
  ...
  description: 'Give the gift of choice — a Petite Lavande gift card for luxury newborn & postpartum gifts. $50–$200, delivered instantly by email.',
  openGraph: { title: 'Petite Lavande Gift Cards', description: 'A gift card for luxury baby & new-mama gifts — delivered instantly by email.' },
  alternates: {
