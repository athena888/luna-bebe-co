  ...
  return (
    <main className="min-h-screen bg-[#faf7f2] flex items-center justify-center px-6 py-16">
      ...
      <div className="max-w-md text-center">
        <p className="font-sans text-[11px] tracking-[0.18em] uppercase font-bold text-[#c9a84c] mb-3">
        ...
        {state === 'valid' && (
          <>
            ...
            <div className="inline-block bg-white border border-dashed border-[#c9a84c] px-7 py-3 mb-2">
              <p className="font-mono text-lg tracking-[0.14em] text-espresso">{ref!.code}</p>
              <p className="font-sans text-[10px] tracking-[0.11em] uppercase text-[#9c7c5a] mt-1">
            ...
            <div className="mt-6">
              <Link
                href="/build"
                className="inline-block bg-[#7A8E7C] text-white font-sans text-[13px] tracking-[0.14em] uppercase py-4 px-12 hover:bg-[#6b7d6d] transition-colors"
              >
                Start Building
              </Link>
            </div>
