...
export const SITE_FAQS_ES: Faq[] = [
  ...
  { q: '¿Todo es seguro para el bebé?', a: 'Cada textil es de algodón orgánico de fabricantes con certificación GOTS, y cada juguete cumple con las normas de seguridad de EE. UU. para recién nacidos. Las notas de seguridad de artículos específicos aparecen en sus páginas de producto.' },
