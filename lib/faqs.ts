...
export const SITE_FAQS: Faq[] = [
  ...
  { q: 'What materials do you use?', a: 'Selected baby textiles are made with organic cotton sourced from certified manufacturers; when a product is made with organic cotton, it is noted on that product\'s page. Other materials, such as silk or specialty fabrics, are identified separately in the relevant product descriptions. Please refer to each product page for applicable age recommendations, materials, safety notes, and care information.' },
  ...
  { q: 'How much is shipping?', a: `Free standard shipping on orders of ${FREE_OVER} or more. Below that, standard shipping is ${STANDARD} and rush is ${RUSH} (1–2 business days).` },
...
export const SITE_FAQS_ES: Faq[] = [
  ...
  { q: '¿Qué materiales usan?', a: 'Ciertos textiles para bebé están hechos con algodón orgánico de fabricantes certificados; cuando un producto es de algodón orgánico, se indica en su página. Otros materiales, como la seda o telas especiales, se identifican por separado en las descripciones de producto correspondientes. Consulta cada página de producto para ver recomendaciones de edad, materiales, notas de seguridad y cuidados.' },
  ...
  { q: '¿Cuánto cuesta el envío?', a: `Envío estándar gratis en pedidos de ${FREE_OVER} o más. Por debajo de eso, el envío estándar cuesta ${STANDARD} y el exprés ${RUSH} (1–2 días hábiles).` },
