...
export const SITE_FAQS: Faq[] = [
  ...
  { q: 'Is everything baby-safe?', a: 'Our cotton baby garments and selected cotton textiles are made with GOTS-certified organic cotton. Other materials, such as silk or specialty fabrics, are identified separately in the relevant product descriptions. Please refer to each product page for applicable age recommendations, materials, safety notes, and care information.' },
