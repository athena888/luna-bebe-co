...
export const SITE_FAQS = [
  ...
  { q: 'How fast does it ship?', a: 'Boxes are hand-packed and ship within 3 days. At checkout you can tell us your occasion date and we\'ll show the order-by date.' },
  { q: 'How much is shipping?', a: 'Free over $100. Below that, standard shipping is $12 (5–7 business days) and rush is $28 (1–2 business days).' },
  ...
  { q: 'What if I need to cancel or return?', a: 'You can cancel within 24 hours of ordering. For returns, see our full returns policy — unopened boxes are returnable within 30 days.' },
]
