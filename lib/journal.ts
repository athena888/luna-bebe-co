...
export const JOURNAL_POSTS: JournalPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { p: 'When it comes to anything that touches a newborn, organic cotton from GOTS-certified makers is the gold standard. It means the fibre is grown and processed to a strict organic and ethical standard — softer on skin, and gentler on the planet.' },
