...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  ...
  bath: [
    ...
    { id: 'bath-shea', name: 'Organic Shea Butter Set', description: 'Raw African shea butter whipped with coconut oil. Zero synthetics. Rich moisture for eczema-prone and sensitive skin.', price: 3200, category: 'bath', imageEmoji: '🥥', ingredients: 'Shea Butter, Coconut Oil, Vitamin E' },
