...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  ...
  garment: [
    ...
    { id: 'garment-sleeper', name: 'Footed Zip Sleeper', description: 'Two-way zip for easy midnight changes. Snug fit with fold-over cuffs. Made with organic cotton.', price: 3600, category: 'garment', imageEmoji: '⭐', tag: 'Nighttime Hero', ingredients: '100% Organic Cotton' },
  ...
  bath: [
    { id: 'bath-botanical', name: 'Botanical Baby Wash Duo', description: 'Chamomile & calendula wash and lotion. Fragrance-free. Packaged in glass.', price: 3600, category: 'bath', imageEmoji: '🌼', ingredients: 'Chamomile, Calendula, Aloe Vera' },
    { id: 'bath-shea', name: 'Organic Shea Butter Set', description: 'Raw African shea butter whipped with coconut oil. Zero synthetics. Rich, nourishing moisture.', price: 3200, category: 'bath', imageEmoji: '🥥', ingredients: 'Shea Butter, Coconut Oil, Vitamin E' },
  ...
  keepsake: [
    { id: 'keepsake-rattle', name: 'Handcrafted Wooden Rattle', description: 'Turned from sustainably sourced maple wood. Smooth, natural finish — no paint, no varnish.', price: 2400, category: 'keepsake', imageEmoji: '🪵', tag: 'Artisan Made', ingredients: 'Sustainably Sourced Maple Wood' },
    { id: 'keepsake-bunny', name: 'Organic Cotton Bunny', description: 'Hand-sewn in organic cotton. Weighted for easy gripping, soft enough to be a first best friend.', price: 2800, category: 'keepsake', imageEmoji: '🐰', tag: 'Handmade', ingredients: '100% Organic Cotton, Hypoallergenic Fill' },
  ...
  mom: [
    ...
    { id: 'mom-tea', name: 'Artisan Loose Leaf Tea Collection', description: '4 organic blends: lactation support, postpartum calm, energy boost, and chamomile sleep. Beautifully tin-packaged.', price: 2600, category: 'mom', imageEmoji: '🍵', tag: 'Lactation Support', ingredients: 'Organic Herbs & Botanicals' },
