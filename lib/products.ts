...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  swaddle: [
    { id: 'swaddle-muslin', name: 'Organic Muslin Swaddle Set', description: 'Ultra-soft GOTS-certified organic cotton muslin. Breathable, pre-washed, and gets softer with every wash. Set of 2.', price: 2800, category: 'swaddle', imageEmoji: '🌿', tag: 'Bestseller', ingredients: '100% GOTS Organic Cotton' },
  ...
  garment: [
    { id: 'garment-gown', name: 'Organic Knotted Gown', description: 'The midnight diaper-change hero. Expandable knotted bottom for easy access. Incredibly soft GOTS-certified cotton.', price: 3400, category: 'garment', imageEmoji: '👶', tag: 'Mom Approved', ingredients: '100% GOTS Organic Cotton' },
    ...
    { id: 'garment-sleeper', name: 'Footed Zip Sleeper', description: 'Two-way zip for easy midnight changes. Snug fit with fold-over cuffs. Certified safe dyes on GOTS cotton.', price: 3600, category: 'garment', imageEmoji: '⭐', tag: 'Nighttime Hero', ingredients: '100% GOTS Organic Cotton' },
