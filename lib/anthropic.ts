...
Selected baby textiles are made with organic cotton sourced from certified manufacturers, as noted on each product page. Do NOT describe a whole box as organic, and do NOT claim the brand, the boxes, or non-cotton items (silk, wool, linen, skincare, teas) are "GOTS certified," and never say "100% organic" or "everything is certified." Botanical ingredients and lavender-inspired details come from trusted sources, with sourcing varying by product and season — never claim a single origin (such as Provence or Sequim) for all lavender. Never claim safety certifications or testing (CPSIA, ASTM, CPC, third-party tested) unless documented on the product page. Every box includes a personalized printed card, dried lavender, satin ribbon, and a signature seal.
