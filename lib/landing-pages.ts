...
export const LANDING_PAGES: LandingPage[] = [
  ...
  // ── Occasion pages (SEO content brief, wave A) ─────────────────────────────
  {
    ...
    metaDescription: 'A baby shower gift made for the mom-to-be — botanical bath comforts, soft organic pieces, and a personalized card. Boxes from $85, finished by hand.',
    ...
    faqs: [
      ...
      { q: 'How much should I spend on a baby shower gift for a mom-to-be?', a: 'Most guests spend between $50 and $150 depending on how close they are. Our boxes range from $85 to $200; a smaller curated box from a close friend typically lands better than a larger generic one.' },
  ...
  },
  {
    ...
    metaDescription: 'A new mom gift box that cares for her — calming lavender, a soothing bath ritual, and quiet luxuries, hand-packed with a personalized card. From $85.',
  ...
  },
  {
    ...
    metaDescription: 'A newborn gift set in organic cotton from GOTS-certified makers — swaddles, soft garments, and keepsakes, hand-packed with a personalized card. From $85.',
  ...
  },
  {
    ...
    metaDescription: 'A second-baby gift that gets it right — nothing she already owns, comfort for a tired mom of two, and a card that celebrates this baby. From $85.',
    ...
    faqs: [
      ...
      { q: 'What does a second-baby box cost?', a: 'The same as our other boxes: $85 to $200 depending on what you include. A focused mother-and-keepsake box sits at the lower end.' },
    ],
    journalLinks: [
      { label: 'Gifts for the New Mom Who Has Everything', href: '/journal/gifts-for-the-new-mom-who-has-everything' },
      { label: 'What to Put in a Postpartum Care Package', href: '/journal/what-to-put-in-a-postpartum-care-package' },
  ...
  },
  {
    ...
    metaDescription: 'A twin baby gift done thoughtfully — matched-not-identical pairs in organic cotton, and real comfort for a mother of two newborns. From $85.',
    eyebrow: 'Two at Once',
    h1: 'Twin Baby Gifts',
    intro: [
  ...
  },
  {
    ...
    metaDescription: 'The office baby gift, solved — one curated box the whole team signs, shipped to their door. Group-worthy from $85 to $200, no collection-envelope chaos.',
    ...
    faqs: [
      ...
      { q: 'Is there something for bigger budgets or executive gifts?', a: 'Our boxes go to $200, and for company-level gifting — clients or employees — see our corporate gifting page.' },
    ],
    journalLinks: [
  ...
  },
  {
    ...
    metaDescription: 'A gentle care package for after a c-section — soft comforts, calming lavender, and easy little luxuries for the slow first weeks. From $85, hand-packed.',
