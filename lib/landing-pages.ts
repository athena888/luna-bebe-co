...
export const LANDING_PAGES: LandingPage[] = [
  {
    ...
    intro: [
      'A new baby deserves the gentlest start — and the people welcoming them deserve a gift that feels as considered as the moment. Our organic newborn gift box is built around soft, breathable pieces made with GOTS-certified organic cotton from a GOTS-certified maker, so everything that touches new skin is as pure as it is beautiful.',
  ...
  },
  {
    ...
    intro: [
      'Baby clothes are the gift everyone remembers — especially when they are this soft. Our organic baby clothes gift set is made with GOTS-certified organic cotton from a GOTS-certified maker: swaddles, rompers, bibs and gentle layers that feel as good as they look and are kind to delicate new skin.',
