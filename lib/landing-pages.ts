...
export const LANDING_PAGES: LandingPage[] = [
  {
    ...
    highlights: ['Organic cotton textiles, where noted', 'Something for the mama too', 'Hand-packed & ribbon-tied', 'Personalized card included'],
  },
  {
  ...
  },
  {
    ...
    highlights: ['Organic cotton newborn pieces, where noted', 'Gentle botanical skincare', 'Personalized printed card', 'Signature seal & linen ribbon'],
  },
  {
  ...
  },
  {
    ...
    highlights: ['Organic cotton pieces, where noted', 'Swaddles, rompers & layers', 'Soft natural colours', 'Hand-folded & gift-ready'],
  },
  {
    slug: 'french-baby-gifts',
    keyword: 'French and European baby gifts',
    title: 'French & European Baby Gifts | Petite Lavande',
    metaDescription: 'French-inspired baby gifts — lavender-inspired details, linen ribbon and quiet European luxury, curated into a hand-finished box. Build your own or shop ready-made.',
    eyebrow: 'À la Française',
    h1: 'French & European Baby Gifts',
    intro: [
      'There is a particular kind of beauty in a French gift — understated, natural, and quietly luxurious. Petite Lavande is built around exactly that feeling: lavender-inspired details, soft linen, muted heirloom tones, and the belief that the most elegant gifts are the most considered ones.',
    ...
    highlights: ['Lavender-inspired details', 'Linen ribbon & signature seal', 'Soft heirloom palette', 'Quiet European luxury'],
  },
  {
  ...
  },
  {
    ...
    moment: {
      ...
      paragraphs: [
        ...
        'Everything in the box passes those tests. The bath and body pieces are botanical and gentle; the lavender is real dried lavender; the card is printed, not scribbled — the kind of thing that ends up kept in a drawer long after the newborn days are over.',
      ],
    },
    faqs: [
  ...
  },
  {
    ...
    metaDescription: 'A newborn gift set in organic cotton — swaddles, soft garments, and keepsakes, hand-packed with a personalized card. From {PRICE_LOW}.',
