...
- Materials claim: selected baby textiles are made with organic cotton, as noted on each product page. Never mention GOTS or any certification of the cotton or its makers. Do NOT describe a whole box, the brand, or non-cotton items as organic, never say "100% organic," and never claim a product is dermatologist tested, eczema safe, safe from birth, or meets a safety standard or certification (CPSIA, ASTM, CPC, third-party tested) unless the customer's product page shows it.
