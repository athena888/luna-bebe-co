...
-- 27) "The First Year" product catalog — the individual items in this line, kept
--     SEPARATE from the main store's products table. Each carries photos, an
--     optional short video, price, sizes, and an optional shipment assignment.
