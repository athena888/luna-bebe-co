...
-- Seed the six tiers (edit inline in Portal → Lookbook → Builder). Corporate
-- prices default to ~5/10/15% off retail at 10/25/50; one-liners are fallbacks
-- used when the AI copy leaves a tier blank. All editable.
