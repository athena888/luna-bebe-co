  ...
  return (
    <div>
      ...
      <div className="lg:hidden">
        ...
        >
          {images.map((src, i) => (
            <div key={i} className="relative shrink-0 w-full aspect-[4/3] snap-center bg-cream-200">
      ...
      <div className="hidden lg:flex gap-3">
        ...
        <div className="relative flex-1 aspect-[4/3] bg-cream-200 overflow-hidden group">
