    ...
    <div className="group">
      <div className="relative aspect-[4/5] bg-[#FBF7F0] overflow-hidden border border-cream-200 mb-3">
        ...
        <button
          ...
          className={`absolute top-2 right-2 z-20 flex items-center gap-1 bg-white/85 text-bark-600 hover:bg-white font-sans text-[11px] tracking-[0.11em] uppercase px-2 py-1 transition-opacity ${
