...
export function RelatedProducts({ items }: { items?: RelatedItem[] }) {
  if (!items?.length) return null
  return (
    <section className="border-t border-cream-300 bg-cream-50 py-12 px-6">
      <div className="max-w-4xl mx-auto">
        <p className="font-sans text-[11px] tracking-[0.3em] uppercase text-gold-400 text-center mb-8">You may also like</p>
