  ...
  return (
    <header className="sticky top-0 z-50 bg-white">
      ...
      <div className="border-b border-cream-300">
        <div className="relative w-full pl-4 sm:pl-9 pr-16 sm:pr-6 h-[68px] md:h-[120px] flex md:items-start md:pt-10 items-center justify-between">

          {/* Logo — left */}
          <Link href="/" className="flex flex-col leading-none shrink-0 md:pt-5">
            <span
