        ...
        <div className="max-w-6xl mx-auto px-6 py-10 sm:py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1.35fr] gap-8 lg:gap-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-8 gap-x-5 sm:gap-x-8 lg:pr-14 xl:pr-24">
              <div>
                <p className="font-serif text-[15px] tracking-[0.1em] uppercase text-espresso font-semibold mb-3 inline-block scale-y-[1.18] origin-bottom">Shop &amp; Gift</p>
              ...
              <div>
                <p className="font-serif text-[15px] tracking-[0.1em] uppercase text-espresso font-semibold mb-3 inline-block scale-y-[1.18] origin-bottom">About</p>
                <ul className="space-y-2 text-[13px] font-sans font-medium">
              ...
              <div>
                <p className="font-serif text-[15px] tracking-[0.1em] uppercase text-espresso font-semibold mb-3 inline-block scale-y-[1.18] origin-bottom">Corporate</p>
                <ul className="space-y-2 text-[13px] font-sans font-medium">
              ...
              <div>
                <p className="font-serif text-[15px] tracking-[0.1em] uppercase text-espresso font-semibold mb-3 inline-block scale-y-[1.18] origin-bottom">Currency</p>
